...
const buttonVariants = {
  ...
  outlinedPrimary: "border-purple-600 text-purple-400 font-medium hover:bg-purple-500 hover:text-white",
...
export default function Button({
  ...
  return (
    <button
      className={`border-2 py-2 px-4 text-white rounded-md m-2 transition flex flex-row items-center ${classes} ${
